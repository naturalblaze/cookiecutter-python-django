import pytest
from hooks.pre_gen_project import validate_no_spaces, validate_no_spaces_begin_or_end, \
    validate_semantic_version, validate_https_url, validate_numbers_letters_hyphens
